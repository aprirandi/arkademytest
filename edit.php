	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_GET['id'])){
			...
			$select = mysqli_query($conn, "SELECT * FROM mahasiswa WHERE id='$id'") or die(mysqli_error($conn));
		...
		if(isset($_POST['submit'])){
			$nama			= $_POST['id'];
			$jenis_kelamin	= $_POST['name'];
			$jurusan		= $_POST['id_salary'];
			
			$sql = mysqli_query($conn, "UPDATE work SET nama='$nama', jenis_kelamin='$jenis_kelamin', jurusan='$jurusan' WHERE id='$id'") or die(mysqli_error($conn));
